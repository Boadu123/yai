  ...
  return (
    <section className="w-full py-20 bg-white" id="contact">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-4xl font-bold text-center text-[#00A896] mb-12">Contact Us</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          {/* Left Section - Contact Details */}
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold text-[#00A896]">Let's Connect</h3>
            <p className="text-gray-700 leading-relaxed text-lg">
              Have questions about our electric motorcycles or want to partner with us? 
              Reach out and let’s discuss how we can revolutionize sustainable transportation together.
            </p>
            <div className="space-y-6 text-lg">
              <div className="flex items-center space-x-4">
                <Mail className="text-[#009c4a] w-6 h-6" />
                <span className="text-gray-700">info@evmotorsghana.com</span>
              </div>
              <div className="flex items-center space-x-4">
          ...
          <div className="bg-gray-50 p-8 rounded-2xl shadow-lg">
            <h3 className="text-2xl font-semibold text-[#00A896] mb-6">Send Us a Message</h3>
